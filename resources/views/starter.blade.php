    ...
    <div x-data="{ show:1 }" class="mx-auto align-bottom px-4 pt-5 pb-4 text-left overflow-hidden sm:my-8 sm:align-middle sm:max-w-xl">
        ...
        <div x-show="show===2" class="transform transition-all">
            ...
            <div class="mt-5 sm:mt-8 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                <a type="button" @click="show=3" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:col-start-2 sm:text-sm">
                    {{ __('a.starter ya')}}
                </a>
        ...
        <div x-show="show===3" class="transform transition-all">
            <div class="mt-3 text-center sm:mt-5">
                <h3 class="text-4xl leading-10 font-medium text-white" id="modal-title">
                    {!! __('a.starter t3') !!}
                </h3>
